...
export const searchProducts = (keyword, params = {}) => axios.get(`${API_BASE_URL}/api/bnq_watches/search/${encodeURIComponent(keyword)}`, { params }).then(({ data }) => data || {}).catch((error) => {console.error('Lỗi khi gọi API:', error)});
